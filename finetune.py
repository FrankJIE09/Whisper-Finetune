...
add_arg("base_model",    type=str, default="openai/whisper-large",      help="Whisper的基础模型")
add_arg("output_dir",    type=str, default="output_sage_version3/",                  help="训练保存模型的路径")
...
add_arg("save_steps",    type=int, default=10,    help="多少步数保存模型一次")
add_arg("num_workers",   type=int, default=8,       help="读取数据的线程数量")
add_arg("learning_rate", type=float, default=1e-2,  help="学习率大小")
...
add_arg("per_device_train_batch_size", type=int, default=10,    help="训练的batch size")
add_arg("per_device_eval_batch_size",  type=int, default=10,    help="评估的batch size")
