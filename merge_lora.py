...
add_arg("lora_model", type=str, default="output_sage/whisper-large/checkpoint-50/", help="微调保存的模型路径")
add_arg('output_dir', type=str, default='models_sage/', help="合并模型的保存目录")
