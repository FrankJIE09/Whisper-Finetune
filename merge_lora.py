...
add_arg("lora_model", type=str, default="output_sage_version2/whisper-tiny/checkpoint-best", help="微调保存的模型路径")
add_arg('output_dir', type=str, default='models_sage_bottle/', help="合并模型的保存目录")
